...
export function LibraryHero() {
    return (
        <div className="w-full rounded-2xl bg-[oklch(0.924_0.028_78)] px-6 py-6 md:px-8 md:py-7 flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="w-full md:flex-shrink-0 md:w-[240px] text-center md:text-left">
                ...
                <p className="text-sm text-[oklch(0.510_0.030_62)] leading-relaxed mb-6 max-w-[280px] md:max-w-[220px] mx-auto md:mx-0">
            ...
            {/* Center — illustration */}
            <div className="w-full h-[180px] md:flex-1 md:h-[200px] relative order-first md:order-none">
                <Image
            ...
            {/* Right — steps */}
            <div className="w-full md:flex-shrink-0 flex flex-row md:flex-col gap-3 md:min-w-[180px]">
                {[
                    ...
                    <div
                        key={n}
                        className="flex-1 md:flex-none flex items-start gap-3 rounded-xl bg-background/70 px-4 py-3 shadow-[0_0_12px_rgba(255,253,208,0.8)]"
                    >
